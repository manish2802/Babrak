...
public class StudentDAO {
	...
	public List<Student> getAllStudentInfo() {
		...
		try {
			...
			while (rs.next()) {// cursor moving
				...
				Student student = new Student(enrollNo, firstName, lastname, phoneNo);
	...
	/**
	 * Get the student inforamtion based on enroll no
	 * 
	 * @param student
	 * @throws ClassNotFoundException
	 */
	public Student getStudentInfo(String enrollNo2) {
		...
		try {
			...
			student = new Student(enrollNo, firstName, lastname, phoneNo);
